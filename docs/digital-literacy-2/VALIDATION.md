...
| Browser tests | 48 passed in Chromium on the rebuilt ElevenLabs delivery |
...
| Final video delivery | Six H.264/AAC 1280×720 24fps MP4s, 17.18 MiB total; complete decode passed, no black intervals, non-silent audio, fast-start containers |
...
Explain Video Generator's trial was completed and its narration/captions were checked separately. After repairing the ElevenLabs connection, all 30 narration takes were regenerated through ElevenLabs MCP using multilingual v2 and the premade Sarah voice. The six delivery MP4s were rebuilt with fresh caption alignment and checked again. Provider settings, source hashes and final take hashes record the replacement; the earlier Kokoro fallback is no longer the delivered narration.
