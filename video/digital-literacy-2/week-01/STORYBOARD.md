...
Scene 1 (0–40.421s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–46.9s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–38.749s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–47.945s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–44.81s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–48.013s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–42.905s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
...
Scene 1 (0–44.13s): Original software demonstration; state changes follow the recognized narration anchors. The original artwork sets context; large diagrams show the change with minimal labels. Keep the bottom band available for optional player captions.
