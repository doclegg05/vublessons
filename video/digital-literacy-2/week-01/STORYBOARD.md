...
mode: autonomous
duration: 427.836s
message: A workstation that supports your task
audience: adult veteran learners
---

## Frame 1 — A workstation that supports your task

- src: compositions/frames/scene-1.html
- duration: 38.656s
- status: animated
- transition_in: cut
- scene: routine / scenario
- photo: workstation
- worked states: Choose|Read a page comfortably; Test|Can I reach the next action?; Restore|Keep the original setting
...
Scene 1 (0–38.656s): Authored fictional demonstration with chapter-specific evidence captions. When present, a landscape scenario photograph or the generated week-1 workstation clip establishes context before the diagram. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
Scene 1 (0–46.248s): Full-screen task simulation with word-aligned cursor, clicks, typed inputs, and verified outcomes; see screen-share-actions.json. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
- status: animated
- transition_in: cut
- scene: scope / demonstration
- photo: none: full-stage authored demonstration
- worked states: Page zoom|Only this webpage grows; Display scaling|Apps and system controls grow; Choose|Make the smallest useful change
...
- status: animated
- transition_in: cut
- scene: sound / demonstration
- photo: none: full-stage authored demonstration
- worked states: Destination|Headset selected; App setting|Check the meeting output too; Test|Unmute and play a short sample
...
Scene 1 (0–39.608s): Authored fictional demonstration with chapter-specific evidence captions. When present, a landscape scenario photograph or the generated week-1 workstation clip establishes context before the diagram. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
- status: animated
- transition_in: cut
- scene: connections / demonstration
- photo: none: full-stage authored demonstration
- worked states: Processor|Carries out instructions; Memory|Current work on the workbench; Storage|Saved file in the cabinet
...
Scene 1 (0–45.529s): Authored fictional demonstration with chapter-specific evidence captions. When present, a landscape scenario photograph or the generated week-1 workstation clip establishes context before the diagram. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
- status: animated
- transition_in: cut
- scene: print / demonstration
- photo: none: full-stage authored demonstration
- worked states: Preview|Destination · range · orientation; Test|Print one page first; Queue|Check before sending it again
...
Scene 1 (0–44.089s): Authored fictional demonstration with chapter-specific evidence captions. When present, a landscape scenario photograph or the generated week-1 workstation clip establishes context before the diagram. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
Scene 1 (0–41.372s): Full-screen task simulation with word-aligned cursor, clicks, typed inputs, and verified outcomes; see screen-share-actions.json. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
- status: animated
- transition_in: cut
- scene: privacy / demonstration
- photo: none: full-stage authored demonstration
- worked states: Owner|Library practice · Room A; Partner|Busy · 2:00–3:00; Verify|Inspect the partner view
...
- status: animated
- transition_in: cut
- scene: automation / demonstration
- photo: none: full-stage authored demonstration
- worked states: Account|Confirm the active account; Reminder|Check notification permission; Help|Match instructions to your version
...
Scene 1 (0–41.14s): Authored fictional demonstration with chapter-specific evidence captions. When present, a landscape scenario photograph or the generated week-1 workstation clip establishes context before the diagram. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
...
- scene: routine / scenario
- photo: workstation
- worked states: Choose|Read · hear · remember; Explain|Expected result versus actual; Finish|Save · restore · sign out
...
Scene 1 (0–43.549s): Authored fictional demonstration with chapter-specific evidence captions. When present, a landscape scenario photograph or the generated week-1 workstation clip establishes context before the diagram. Britt audio, chapter windows and existing caption files are retained in visual-only mode.
